window.Vaadin.Flow.feature_AttributesCorrelationInfoSummaryChart = {
    initLazy: function (c) {
        ...
        am5.ready(function() {
            ...
            c.$connector.series = c.$connector.root.container.children.push(am5hierarchy.VoronoiTreemap.new(c.$connector.root, {
                paddingLeft: 1,
                paddingRight: 1,
                paddingTop: 1,
                paddingBottom: 1,
            ...
            c.$connector.series.labels.template.adapters.add("x", function (x, target) {
            ...
            c.$connector.series.nodes.template.events.on("click", function (e) {
                var dataItem = e.target.dataItem ;
                if (dataItem) {
                    if (!dataItem.get("children")) {
                        c.$connector.series.selectDataItem(dataItem.get("parent"));
                    }
                }
            });
