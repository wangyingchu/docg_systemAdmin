...
`);let Ze=class extends A{constructor(){super(...arguments),this.value=D.local}static get styles(){return x`
    ...
    ></vaadin-select>`}selectRenderer(o){var e;const t=((e=this.metadata)==null?void 0:e.displayName)||"Component",r=`${t}s`;Ie(f`
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};jr=Zs([F("vaadin-dev-tools-theme-text-property-editor")],jr);var ea=Object.defineProperty,ta=Object.getOwnPropertyDescriptor,jo=(o,e,t,r)=>{for(var i=r>1?void 0:r?ta(e,t):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(i=(r?s(e,t,i):s(i))||i);return r&&i&&ea(e,t,i),i};let At=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new Nt}static get styles(){return[W.styles,x`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
