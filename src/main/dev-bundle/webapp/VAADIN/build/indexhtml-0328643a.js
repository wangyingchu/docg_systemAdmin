...
This is probably caused by illegal octal escape sequences.`),{_$litType$:o,strings:e,values:t}),R=Ko(vn),$r=Ko(Ye),Z=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),wo=new WeakMap,ce=we.createTreeWalker(we,129,null,!1);let ee=Xe;const _n=(o,e)=>{const t=o.length-1,i=[];let n=e===Ye?"<svg>":"",r,s=fe;for(let a=0;a<t;a++){const c=o[a];let u=-1,p,m=0,f;for(;m<c.length&&(s.lastIndex=m,f=s.exec(c),f!==null);)if(m=s.lastIndex,s===fe){if(f[go]==="!--")s=vo;else if(f[go]!==void 0)s=bo;else if(f[gt]!==void 0)qo.test(f[gt])&&(r=new RegExp(`</${f[gt]}`,"g")),s=X;else if(f[pn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===X?f[fn]===">"?(s=r??fe,u=-1):f[yo]===void 0?u=-2:(u=s.lastIndex-f[gn].length,p=f[yo],s=f[xo]===void 0?X:f[xo]==='"'?bt:vt):s===bt||s===vt?s=X:s===vo||s===bo?s=fe:(s=X,r=void 0);console.assert(u===-1||s===X||s===vt||s===bt,"unexpected parse state B");const G=s===X&&o[a+1].startsWith("/>")?" ":"";n+=s===fe?c+dn:u>=0?(i.push(p),c.slice(0,u)+It+c.slice(u)+W+G):c+W+(u===-2?(i.push(void 0),a):G)}const l=n+(o[t]||"<?>")+(e===Ye?"</svg>":"");if(!Array.isArray(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(a)}return[fo!==void 0?fo.createHTML(l):l,i]};class Ee{constructor({strings:e,["_$litType$"]:t},i){this.parts=[];let n,r=0,s=0;const l=e.length-1,a=this.parts,[c,u]=_n(e,t);if(this.el=Ee.createElement(c,i),ce.currentNode=this.el.content,t===Ye){const p=this.el.content,m=p.firstChild;m.remove(),p.append(...m.childNodes)}for(;(n=ce.nextNode())!==null&&a.length<l;){if(n.nodeType===1){{const p=n.localName;if(/^(?:textarea|template)$/i.test(p)&&n.innerHTML.includes(W)){const m=`Expressions are not supported inside \`${p}\` elements. See https://lit.dev/msg/expression-in-${p} for more information.`;if(p==="template")throw new Error(m);Ke("",m)}}if(n.hasAttributes()){const p=[];for(const m of n.getAttributeNames())if(m.endsWith(It)||m.startsWith(W)){const f=u[s++];if(p.push(m),f!==void 0){const q=n.getAttribute(f.toLowerCase()+It).split(W),j=/([.?@])?(.*)/.exec(f);a.push({type:Mt,index:r,name:j[2],strings:q,ctor:j[1]==="."?En:j[1]==="?"?Tn:j[1]==="@"?$n:Qe})}else a.push({type:Dt,index:r})}for(const m of p)n.removeAttribute(m)}if(qo.test(n.tagName)){const p=n.textContent.split(W),m=p.length-1;if(m>0){n.textContent=de?de.emptyScript:"";for(let f=0;f<m;f++)n.append(p[f],_e()),ce.nextNode(),a.push({type:Je,index:++r});n.append(p[m],_e())}}}else if(n.nodeType===8)if(n.data===Wo)a.push({type:Je,index:r});else{let m=-1;for(;(m=n.data.indexOf(W,m+1))!==-1;)a.push({type:wn,index:r}),m+=W.length-1}r++}g==null||g({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,t){const i=we.createElement("template");return i.innerHTML=e,i}}function ue(o,e,t=o,i){var n,r,s,l;if(e===Z)return e;let a=i!==void 0?(n=t.__directives)===null||n===void 0?void 0:n[i]:t.__directive;const c=Se(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==c&&((r=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||r===void 0||r.call(a,!1),c===void 0?a=void 0:(a=new c(o),a._$initialize(o,t,i)),i!==void 0?((s=(l=t).__directives)!==null&&s!==void 0?s:l.__directives=[])[i]=a:t.__directive=a),a!==void 0&&(e=ue(o,a._$resolve(o,e.values),a,i)),e}class Sn{constructor(e,t){this._parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=t}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var t;const{el:{content:i},parts:n}=this._$template,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:we).importNode(i,!0);ce.currentNode=r;let s=ce.nextNode(),l=0,a=0,c=n[0];for(;c!==void 0;){if(l===c.index){let u;c.type===Je?u=new $e(s,s.nextSibling,this,e):c.type===Mt?u=new c.ctor(s,c.name,c.strings,this,e):c.type===Dt&&(u=new kn(s,this,e)),this._parts.push(u),c=n[++a]}l!==(c==null?void 0:c.index)&&(s=ce.nextNode(),l++)}return r}_update(e){let t=0;for(const i of this._parts)i!==void 0&&(g==null||g({kind:"set part",part:i,value:e[t],valueIndex:t,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,t),t+=i.strings.length-2):i._$setValue(e[t])),t++}}class $e{constructor(e,t,i,n){var r;this.type=Je,this._$committedValue=S,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=t,this._$parent=i,this.options=n,this.__isConnected=(r=n==null?void 0:n.isConnected)!==null&&r!==void 0?r:!0,this._textSanitizer=void 0}get _$isConnected(){var e,t;return(t=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&t!==void 0?t:this.__isConnected}get parentNode(){let e=P(this._$startNode).parentNode;const t=this._$parent;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,t=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=ue(this,e,t),Se(e))e===S||e==null||e===""?(this._$committedValue!==S&&(g==null||g({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=S):e!==this._$committedValue&&e!==Z&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)===null||i===void 0?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else un(e)?this._commitIterable(e):this._commitText(e)}_insert(e,t=this._$endNode){return P(P(this._$startNode).parentNode).insertBefore(e,t)}_commitNode(e){var t;if(this._$committedValue!==e){if(this._$clear(),ee!==Xe){const i=(t=this._$startNode.parentNode)===null||t===void 0?void 0:t.nodeName;if(i==="STYLE"||i==="SCRIPT"){let n="Forbidden";throw i==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}g==null||g({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==S&&Se(this._$committedValue)){const t=P(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=Nt(t,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}else{const t=document.createTextNode("");this._commitNode(t),this._textSanitizer===void 0&&(this._textSanitizer=Nt(t,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:t,value:e,options:this.options}),t.data=e}this._$committedValue=e}_commitTemplateResult(e){var t;const{values:i,["_$litType$"]:n}=e,r=typeof n=="number"?this._$getTemplate(e):(n.el===void 0&&(n.el=Ee.createElement(n.h,this.options)),n);if(((t=this._$committedValue)===null||t===void 0?void 0:t._$template)===r)g==null||g({kind:"template updating",template:r,instance:this._$committedValue,parts:this._$committedValue._parts,options:this.options,values:i}),this._$committedValue._update(i);else{const s=new Sn(r,this),l=s._clone(this.options);g==null||g({kind:"template instantiated",template:r,instance:s,parts:s._parts,options:this.options,fragment:l,values:i}),s._update(i),g==null||g({kind:"template instantiated and updated",template:r,instance:s,parts:s._parts,options:this.options,fragment:l,values:i}),this._commitNode(l),this._$committedValue=s}}_$getTemplate(e){let t=wo.get(e.strings);return t===void 0&&wo.set(e.strings,t=new Ee(e)),t}_commitIterable(e){Go(this._$committedValue)||(this._$committedValue=[],this._$clear());const t=this._$committedValue;let i=0,n;for(const r of e)i===t.length?t.push(n=new $e(this._insert(_e()),this._insert(_e()),this,this.options)):n=t[i],n._$setValue(r),i++;i<t.length&&(this._$clear(n&&P(n._$endNode).nextSibling,i),t.length=i)}_$clear(e=P(this._$startNode).nextSibling,t){var i;for((i=this._$notifyConnectionChanged)===null||i===void 0||i.call(this,!1,!0,t);e&&e!==this._$endNode;){const n=P(e).nextSibling;P(e).remove(),e=n}}setConnected(e){var t;if(this._$parent===void 0)this.__isConnected=e,(t=this._$notifyConnectionChanged)===null||t===void 0||t.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Qe{constructor(e,t,i,n,r){this.type=Mt,this._$committedValue=S,this._$disconnectableChildren=void 0,this.element=e,this.name=t,this._$parent=n,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=S,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,t=this,i,n){const r=this.strings;let s=!1;if(r===void 0)e=ue(this,e,t,0),s=!Se(e)||e!==this._$committedValue&&e!==Z,s&&(this._$committedValue=e);else{const l=e;e=r[0];let a,c;for(a=0;a<r.length-1;a++)c=ue(this,l[i+a],t,a),c===Z&&(c=this._$committedValue[a]),s||(s=!Se(c)||c!==this._$committedValue[a]),c===S?e=S:e!==S&&(e+=(c??"")+r[a+1]),this._$committedValue[a]=c}s&&!n&&this._commitValue(e)}_commitValue(e){e===S?P(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=ee(this.element,this.name,"attribute")),e=this._sanitizer(e??""),g==null||g({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),P(this.element).setAttribute(this.name,e??""))}}class En extends Qe{constructor(){super(...arguments),this.type=bn}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=ee(this.element,this.name,"property")),e=this._sanitizer(e),g==null||g({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===S?void 0:e}}const Cn=de?de.emptyScript:"";class Tn extends Qe{constructor(){super(...arguments),this.type=yn}_commitValue(e){g==null||g({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==S),options:this.options}),e&&e!==S?P(this.element).setAttribute(this.name,Cn):P(this.element).removeAttribute(this.name)}}class $n extends Qe{constructor(e,t,i,n,r){if(super(e,t,i,n,r),this.type=xn,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${t}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,t=this){var i;if(e=(i=ue(this,e,t,0))!==null&&i!==void 0?i:S,e===Z)return;const n=this._$committedValue,r=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,s=e!==S&&(n===S||r);g==null||g({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:r,addListener:s,oldListener:n}),r&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var t,i;typeof this._$committedValue=="function"?this._$committedValue.call((i=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&i!==void 0?i:this.element,e):this._$committedValue.handleEvent(e)}}class kn{constructor(e,t,i){this.element=e,this.type=Dt,this._$disconnectableChildren=void 0,this._$parent=t,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){g==null||g({kind:"commit to element binding",element:this.element,value:e,options:this.options}),ue(this,e)}}const yt=I.litHtmlPolyfillSupportDevMode;yt==null||yt(Ee,$e);((pt=I.litHtmlVersions)!==null&&pt!==void 0?pt:I.litHtmlVersions=[]).push("2.6.1");I.litHtmlVersions.length>1&&Ke("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const Fe=(o,e,t)=>{var i,n;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const r=sn++,s=(i=t==null?void 0:t.renderBefore)!==null&&i!==void 0?i:e;let l=s._$litPart$;if(g==null||g({kind:"begin render",id:r,value:o,container:e,options:t,part:l}),l===void 0){const a=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:null;s._$litPart$=l=new $e(e.insertBefore(_e(),a),a,void 0,t??{})}return l._$setValue(o),g==null||g({kind:"end render",id:r,value:o,container:e,options:t,part:l}),l};Fe.setSanitizer=ln,Fe.createSanitizer=Nt,Fe._testOnlyClearSanitizerFactoryDoNotCallOrElse=cn;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */class Mn extends zn{constructor(e){var t;if(super(e),e.type!==Pn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,n;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(s))&&this._previousClasses.add(s);return this.render(t)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in t||(r.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return Z}}const Yo=On(Mn),Ct="css-loading-indicator";var z;(function(o){o.IDLE="",o.FIRST="first",o.SECOND="second",o.THIRD="third"})(z||(z={}));class C extends te{constructor(){super(),this.firstDelay=300,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=z.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=E.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const i=window;return!((e=i.Vaadin)===null||e===void 0)&&e.connectionIndicator||(i.Vaadin=i.Vaadin||{},i.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(i.Vaadin.connectionIndicator)),(t=i.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return R`
...
`,x=class extends te{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[y`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,je(()=>import("./component-picker-ee14537b.js"),[],import.meta.url)}}
        >
...
`)+t.textContent.trim()).join("").replace(/^\n/,"");Wn(e),this.showNotification("information","Environment information copied to clipboard",void 0,void 0,"versionInfoCopied")}toggleFeatureFlag(o,e){const t=o.target.checked;this.frontendConnection?(this.frontendConnection.setFeature(e.id,t),this.showNotification("information",`“${e.title}” ${t?"enabled":"disabled"}`,e.requiresServerRestart?"This feature requires a server restart":void 0,void 0,`feature${e.id}${t?"Enabled":"Disabled"}`)):this.log("error",`Unable to toggle feature ${e.title}: No server connection available`)}};let b=x;b.BLUE_HSL=y`206, 100%, 70%`;b.GREEN_HSL=y`145, 80%, 42%`;b.GREY_HSL=y`0, 0%, 50%`;b.YELLOW_HSL=y`38, 98%, 64%`;b.RED_HSL=y`355, 100%, 68%`;b.MAX_LOG_ROWS=1e3;b.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE="vaadin.live-reload.dismissedNotifications";b.ACTIVE_KEY_IN_SESSION_STORAGE="vaadin.live-reload.active";b.TRIGGERED_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggered";b.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggeredCount";b.AUTO_DEMOTE_NOTIFICATION_DELAY=5e3;b.HOTSWAP_AGENT="HOTSWAP_AGENT";b.JREBEL="JREBEL";b.SPRING_BOOT_DEVTOOLS="SPRING_BOOT_DEVTOOLS";b.BACKEND_DISPLAY_NAME={HOTSWAP_AGENT:"HotswapAgent",JREBEL:"JRebel",SPRING_BOOT_DEVTOOLS:"Spring Boot Devtools"};$([_({type:String})],b.prototype,"url",2);$([_({type:Boolean,attribute:!0})],b.prototype,"liveReloadDisabled",2);$([_({type:String})],b.prototype,"backend",2);$([_({type:Number})],b.prototype,"springBootLiveReloadPort",2);$([_({type:Boolean,attribute:!1})],b.prototype,"expanded",2);$([_({type:Array,attribute:!1})],b.prototype,"messages",2);$([_({type:String,attribute:!1})],b.prototype,"splashMessage",2);$([_({type:Array,attribute:!1})],b.prototype,"notifications",2);$([_({type:String,attribute:!1})],b.prototype,"frontendStatus",2);$([_({type:String,attribute:!1})],b.prototype,"javaStatus",2);$([pe()],b.prototype,"tabs",2);$([pe()],b.prototype,"activeTab",2);$([pe()],b.prototype,"serverInfo",2);$([pe()],b.prototype,"features",2);$([pe()],b.prototype,"unreadErrors",2);$([Ln(".window")],b.prototype,"root",2);$([pe()],b.prototype,"componentPickActive",2);customElements.get("vaadin-dev-tools")===void 0&&customElements.define("vaadin-dev-tools",b);(function(){if(typeof document>"u"||"adoptedStyleSheets"in document)return;var o="ShadyCSS"in window&&!ShadyCSS.nativeShadow,e=document.implementation.createHTMLDocument(""),t=new WeakMap,i=typeof DOMException=="object"?Error:DOMException,n=Object.defineProperty,r=Array.prototype.forEach,s=/@import.+?;?$/gm;function l(d){var h=d.replace(s,"");return h!==d&&console.warn("@import rules are not allowed here. See https://github.com/WICG/construct-stylesheets/issues/119#issuecomment-588352418"),h.trim()}function a(d){return"isConnected"in d?d.isConnected:document.contains(d)}function c(d){return d.filter(function(h,v){return d.indexOf(h)===v})}function u(d,h){return d.filter(function(v){return h.indexOf(v)===-1})}function p(d){d.parentNode.removeChild(d)}function m(d){return d.shadowRoot||t.get(d)}var f=["addRule","deleteRule","insertRule","removeRule"],G=CSSStyleSheet,q=G.prototype;q.replace=function(){return Promise.reject(new i("Can't call replace on non-constructed CSSStyleSheets."))},q.replaceSync=function(){throw new i("Failed to execute 'replaceSync' on 'CSSStyleSheet': Can't call replaceSync on non-constructed CSSStyleSheets.")};function j(d){return typeof d=="object"?ne.isPrototypeOf(d)||q.isPrototypeOf(d):!1}function Ze(d){return typeof d=="object"?q.isPrototypeOf(d):!1}var A=new WeakMap,V=new WeakMap,oe=new WeakMap,ie=new WeakMap;function et(d,h){var v=document.createElement("style");return oe.get(d).set(h,v),V.get(d).push(h),v}function H(d,h){return oe.get(d).get(h)}function Re(d,h){oe.get(d).delete(h),V.set(d,V.get(d).filter(function(v){return v!==h}))}function Bt(d,h){requestAnimationFrame(function(){h.textContent=A.get(d).textContent,ie.get(d).forEach(function(v){return h.sheet[v.method].apply(h.sheet,v.args)})})}function Ne(d){if(!A.has(d))throw new TypeError("Illegal invocation")}function tt(){var d=this,h=document.createElement("style");e.body.appendChild(h),A.set(d,h),V.set(d,[]),oe.set(d,new WeakMap),ie.set(d,[])}var ne=tt.prototype;ne.replace=function(h){try{return this.replaceSync(h),Promise.resolve(this)}catch(v){return Promise.reject(v)}},ne.replaceSync=function(h){if(Ne(this),typeof h=="string"){var v=this;A.get(v).textContent=l(h),ie.set(v,[]),V.get(v).forEach(function(k){k.isConnected()&&Bt(v,H(v,k))})}},n(ne,"cssRules",{configurable:!0,enumerable:!0,get:function(){return Ne(this),A.get(this).sheet.cssRules}}),n(ne,"media",{configurable:!0,enumerable:!0,get:function(){return Ne(this),A.get(this).sheet.media}}),f.forEach(function(d){ne[d]=function(){var h=this;Ne(h);var v=arguments;ie.get(h).push({method:d,args:v}),V.get(h).forEach(function(N){if(N.isConnected()){var T=H(h,N).sheet;T[d].apply(T,v)}});var k=A.get(h).sheet;return k[d].apply(k,v)}}),n(tt,Symbol.hasInstance,{configurable:!0,value:j});var jt={childList:!0,subtree:!0},Ht=new WeakMap;function re(d){var h=Ht.get(d);return h||(h=new qt(d),Ht.set(d,h)),h}function Wt(d){n(d.prototype,"adoptedStyleSheets",{configurable:!0,enumerable:!0,get:function(){return re(this).sheets},set:function(h){re(this).update(h)}})}function ot(d,h){for(var v=document.createNodeIterator(d,NodeFilter.SHOW_ELEMENT,function(N){return m(N)?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT},null,!1),k=void 0;k=v.nextNode();)h(m(k))}var Ie=new WeakMap,se=new WeakMap,Le=new WeakMap;function ui(d,h){return h instanceof HTMLStyleElement&&se.get(d).some(function(v){return H(v,d)})}function Gt(d){var h=Ie.get(d);return h instanceof Document?h.body:h}function it(d){var h=document.createDocumentFragment(),v=se.get(d),k=Le.get(d),N=Gt(d);k.disconnect(),v.forEach(function(T){h.appendChild(H(T,d)||et(T,d))}),N.insertBefore(h,null),k.observe(N,jt),v.forEach(function(T){Bt(T,H(T,d))})}function qt(d){var h=this;h.sheets=[],Ie.set(h,d),se.set(h,[]),Le.set(h,new MutationObserver(function(v,k){if(!document){k.disconnect();return}v.forEach(function(N){o||r.call(N.addedNodes,function(T){T instanceof Element&&ot(T,function(ae){re(ae).connect()})}),r.call(N.removedNodes,function(T){T instanceof Element&&(ui(h,T)&&it(h),o||ot(T,function(ae){re(ae).disconnect()}))})})}))}if(qt.prototype={isConnected:function(){var d=Ie.get(this);return d instanceof Document?d.readyState!=="loading":a(d.host)},connect:function(){var d=Gt(this);Le.get(this).observe(d,jt),se.get(this).length>0&&it(this),ot(d,function(h){re(h).connect()})},disconnect:function(){Le.get(this).disconnect()},update:function(d){var h=this,v=Ie.get(h)===document?"Document":"ShadowRoot";if(!Array.isArray(d))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+v+": Iterator getter is not callable.");if(!d.every(j))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+v+": Failed to convert value to 'CSSStyleSheet'");if(d.some(Ze))throw new TypeError("Failed to set the 'adoptedStyleSheets' property on "+v+": Can't adopt non-constructed stylesheets");h.sheets=d;var k=se.get(h),N=c(d),T=u(k,N);T.forEach(function(ae){p(H(ae,h)),Re(ae,h)}),se.set(h,N),h.isConnected()&&N.length>0&&it(h)}},window.CSSStyleSheet=tt,Wt(Document),"ShadowRoot"in window){Wt(ShadowRoot);var Kt=Element.prototype,mi=Kt.attachShadow;Kt.attachShadow=function(h){var v=mi.call(this,h);return h.mode==="closed"&&t.set(this,v),v}}var Ae=re(document);Ae.isConnected()?Ae.connect():document.addEventListener("DOMContentLoaded",Ae.connect.bind(Ae))})();/**
 * @license
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Zo=[];function ei(o){return o&&Object.prototype.hasOwnProperty.call(o,"__themes")}function Zn(o){return ei(customElements.get(o))}function er(o=[]){return[o].flat(1/0).filter(e=>e instanceof zt?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function ke(o,e,t={}){o&&Zn(o)&&console.warn(`The custom element definition for "${o}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=er(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(o,e,t):Zo.push({themeFor:o,styles:e,include:t.include,moduleId:t.moduleId})}function Lt(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Zo}function tr(o,e){return(o||"").split(" ").some(t=>new RegExp(`^${t.split("*").join(".*")}$`,"u").test(e))}function or(o=""){let e=0;return o.startsWith("lumo-")||o.startsWith("material-")?e=1:o.startsWith("vaadin-")&&(e=2),e}function ti(o){const e=[];return o.include&&[].concat(o.include).forEach(t=>{const i=Lt().find(n=>n.moduleId===t);i?e.push(...ti(i),...i.styles):console.warn(`Included moduleId ${t} not found in style registry`)},o.styles),e}function ir(o,e){const t=document.createElement("style");t.innerHTML=o.map(i=>i.cssText).join(`
`),e.content.appendChild(t)}function nr(o){const e=`${o}-default-theme`,t=Lt().filter(i=>i.moduleId!==e&&tr(i.themeFor,o)).map(i=>({...i,styles:[...ti(i),...i.styles],includePriority:or(i.moduleId)})).sort((i,n)=>n.includePriority-i.includePriority);return t.length>0?t:Lt().filter(i=>i.moduleId===e)}const Rr=o=>class extends Qn(o){static finalize(){if(super.finalize(),this.elementStyles)return;const t=this.prototype._template;!t||ei(this)||ir(this.getStylesForThis(),t)}static finalizeStyles(t){const i=this.getStylesForThis();return t?[...super.finalizeStyles(t),...i]:i}static getStylesForThis(){const t=Object.getPrototypeOf(this.prototype),i=(t?t.constructor.__themes:[])||[];this.__themes=[...i,...nr(this.is)];const n=this.__themes.flatMap(r=>r.styles);return n.filter((r,s)=>s===n.lastIndexOf(r))}},{toString:rr}=Object.prototype;function sr(o){return rr.call(o)==="[object RegExp]"}function ar(o,{preserve:e=!0,whitespace:t=!0,all:i}={}){if(i)throw new Error("The `all` option is no longer supported. Use the `preserve` option instead.");let n=e,r;typeof e=="function"?(n=!1,r=e):sr(e)&&(n=!1,r=u=>e.test(u));let s=!1,l="",a="",c="";for(let u=0;u<o.length;u++){if(l=o[u],o[u-1]!=="\\"&&(l==='"'||l==="'")&&(s===l?s=!1:s||(s=l)),!s&&l==="/"&&o[u+1]==="*"){const p=o[u+2]==="!";let m=u+2;for(;m<o.length;m++){if(o[m]==="*"&&o[m+1]==="/"){n&&p||r&&r(a)?c+=`/*${a}*/`:t||(o[m+2]===`
`?m++:o[m+2]+o[m+3]===`\r
`&&(m+=2)),a="";break}a+=o[m]}u=m+1;continue}c+=l}return c}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class lr extends HTMLElement{static get version(){return"24.0.0"}}customElements.define("vaadin-lumo-styles",lr);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cr=y`
...
`;ke("",oi,{moduleId:"lumo-typography"});const ii=document.createElement("template");ii.innerHTML=`<style>${cr.toString().replace(":host","html")}</style>`;document.head.appendChild(ii.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const dr=y`
...
`,ni=document.createElement("template");ni.innerHTML=`<style>${dr.toString().replace(":host","html")}</style>`;document.head.appendChild(ni.content);const ri=y`
  [theme~='dark'] {
    /* Base (background) */
...
${yr}
${xr}
`;ke("",di,{moduleId:"lumo-utility"});const wr=`::-webkit-scrollbar-thumb{background-color:#aaa;height:50px;outline-offset:-2px;outline:2px solid #fff;-webkit-border-radius:4px;border:2px solid #fff}::-webkit-scrollbar-thumb:hover{background-color:#aaa;height:50px;-webkit-border-radius:4px}::-webkit-scrollbar{width:7px;height:7px}::-webkit-scrollbar-track-piece{background-color:#fff;-webkit-border-radius:0}
`,_r=(o,e)=>{const t=/(?:@media\s(.+?))?(?:\s{)?\@import\s*(?:url\(\s*['"]?(.+?)['"]?\s*\)|(["'])((?:\\.|[^\\])*?)\3)([^;]*);(?:})?/g;/\/\*(.|[\r\n])*?\*\//gm.exec(o)!=null&&(o=ar(o));for(var i,n=o;(i=t.exec(o))!==null;){n=n.replace(i[0],"");const r=document.createElement("link");r.rel="stylesheet",r.href=i[2]||i[4];const s=i[1]||i[5];s&&(r.media=s),e===document?document.head.appendChild(r):e.appendChild(r)}return n},ve=(o,e,t)=>{if(e===document){const n=Sr(o);if(window.Vaadin.theme.injectedGlobalCss.indexOf(n)!==-1)return;window.Vaadin.theme.injectedGlobalCss.push(n)}const i=new CSSStyleSheet;i.replaceSync(_r(o,e)),t?e.adoptedStyleSheets=[i,...e.adoptedStyleSheets]:e.adoptedStyleSheets=[...e.adoptedStyleSheets,i]};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];function $o(o){let e,t,i=2166136261;for(e=0,t=o.length;e<t;e++)i^=o.charCodeAt(e),i+=(i<<1)+(i<<4)+(i<<7)+(i<<8)+(i<<24);return("0000000"+(i>>>0).toString(16)).substr(-8)}function Sr(o){let e=$o(o);return e+$o(e+o)}const Er=o=>{o!==document&&(ve(oi.cssText,o,!0),ve(ri.cssText,o,!0),ve(si.cssText,o,!0)),ve(ci.cssText,o,!0),ve(di.cssText,o,!0),document["_vaadintheme_docg-pac_componentCss"]||(ke("vaadin-grid",Uo(wr.toString())),document["_vaadintheme_docg-pac_componentCss"]=!0)},Cr=Er;Cr(document);export{zn as D,te as L,Pn as P,Rr as T,Qn as a,Fe as b,y as c,Z as d,On as e,ri as f,Zo as g,R as h,_ as i,pe as j,S as n,Xn as p,Ln as q,ke as r,$r as s,oi as t,Uo as u};
