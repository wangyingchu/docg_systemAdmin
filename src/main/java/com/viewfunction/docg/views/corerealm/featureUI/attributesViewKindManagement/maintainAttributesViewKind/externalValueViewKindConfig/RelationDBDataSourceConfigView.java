...
public class RelationDBDataSourceConfigView extends VerticalLayout {
    ...
    public RelationDBDataSourceConfigView(AttributesViewKind attributesViewKind){
        ...
        dbHostField.setHelperText("DOCG_ExternalRelationDB_Host");
        ...
        dbPortField.setHelperText("DOCG_ExternalRelationDB_Port");
        ...
        databaseNameField.setHelperText("DOCG_ExternalRelationDB_DefaultDBName");
        ...
        tableNameField.setHelperText("DOCG_ExternalRelationDB_DefaultTableName");
    ...
    private void doConfigExternalDataSource(){
        ...
        if(tableNameField.equals("")){
            inputValidateResult = false;
            this.tableNameField.setInvalid(true);
        }
