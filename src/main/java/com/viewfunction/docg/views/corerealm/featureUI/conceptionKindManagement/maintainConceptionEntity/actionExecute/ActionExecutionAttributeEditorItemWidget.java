...
public class ActionExecutionAttributeEditorItemWidget extends VerticalLayout {
    ...
    private ActionExecutionControlView containerActionExecutionControlView;

    public ActionExecutionAttributeEditorItemWidget(AttributeValue attributeValue){
        ...
        Icon propertyTypeIcon = VaadinIcon.RHOMBUS.create();
        ...
        deleteAttributeButton.setTooltipText("删除属性");
    ...
    private void deleteAttribute(){
        if(this.containerActionExecutionControlView != null){
            this.containerActionExecutionControlView.deleteActionAttribute(getAttributeValue().getAttributeName(),this);
        }
    }
    ...
    public ActionExecutionControlView getContainerActionExecutionControlView() {
        return containerActionExecutionControlView;
    }

    public void setContainerActionExecutionControlView(ActionExecutionControlView containerActionExecutionControlView) {
        this.containerActionExecutionControlView = containerActionExecutionControlView;
    }
}
