...
public class EntitiesPathTopologyChart extends VerticalLayout {

    public interface EntitiesPathTopologyChartOperationHandler {
    ...
    public void unselectConceptionEntity(String entityType,String entityUID) {
        ...
        if(entitiesPathTopologyChartOperationHandler != null){
            entitiesPathTopologyChartOperationHandler.unselectConceptionEntity(entityType,entityUID);
        }
    }
    ...
    public void selectConceptionEntity(String entityType,String entityUID) {
        ...
        if(entitiesPathTopologyChartOperationHandler != null){
            ...
            entitiesPathTopologyChartOperationHandler.selectConceptionEntity(entityType,entityUID);
        }
    }
    ...
    public void unselectRelationEntity(String entityTypeAnUIDStr) {
        ...
        if(entitiesPathTopologyChartOperationHandler != null){
            entitiesPathTopologyChartOperationHandler.unselectRelationEntity(relationEntityType,relationEntityUID);
        }
    }
    ...
    public void selectRelationEntity(String entityTypeAnUIDStr) {
        ...
        if(entitiesPathTopologyChartOperationHandler != null){
            entitiesPathTopologyChartOperationHandler.selectRelationEntity(relationEntityType,relationEntityUID);
        }
    }
    ...
    public void setEntitiesPathTopologyChartOperationHandler(EntitiesPathTopologyChartOperationHandler entitiesPathTopologyChartOperationHandler) {
        this.entitiesPathTopologyChartOperationHandler = entitiesPathTopologyChartOperationHandler;
    }
}
