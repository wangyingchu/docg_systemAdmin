...
public class AddCustomEntityAttributeUI extends VerticalLayout {
        ...
        confirmButton.addClickListener(new ComponentEventListener<ClickEvent<Button>>() {
            ...
            public void onComponentEvent(ClickEvent<Button> buttonClickEvent) {
                if(propertyNameField.getValue().equals("")||propertyDataTypeFilterSelect.getValue()==null){
                    ...
                    getAddConceptionEntityView().addAttributeCreatorItem(propertyNameField.getValue(),propertyDataTypeFilterSelect.getValue());
