...
public class ClassificationConfigView extends VerticalLayout {
    ...
    private void renderClassificationConfigUI(){
        ...
        LightGridColumnHeader gridColumnHeader_1_idx3 = new LightGridColumnHeader(LineAwesomeIconsSvg.FIRSTDRAFT.create(),"关系属性");
    ...
    private void renderRelateClassificationViewUI(){
        ...
        FixSizeWindow fixSizeWindow = new FixSizeWindow(new Icon(VaadinIcon.BOOKMARK),"关联分类",null,true,1140,680,false);
