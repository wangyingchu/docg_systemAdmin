    ...
    private void doAttachConceptionType(KindMetaInfo conceptionKindMetaInfo){
        ...
        try {
            ...
            if(targetConceptionKind != null){
                List<AttributesViewKind> containsViewKindList = targetConceptionKind.getContainsAttributesViewKinds();
                ...
                if(attachResult){
                    CommonUIOperationUtil.showPopupNotification("将属性视图类型 "+this.attributesViewKindUID+ " 附加到概念类型 "+ conceptionKindMetaInfo.getKindName() +" : "+conceptionKindMetaInfo.getKindDesc() +" 成功", NotificationVariant.LUMO_SUCCESS);
                    ...
                    CommonUIOperationUtil.showPopupNotification("将属性视图类型 "+this.attributesViewKindUID+ " 附加到概念类型 "+ conceptionKindMetaInfo.getKindName() +" : "+conceptionKindMetaInfo.getKindDesc() +" 失败", NotificationVariant.LUMO_ERROR);
                }
            }
