...
public class ConceptionDataRealtimeInfoWidget extends VerticalLayout {
                    ...
                    if(conceptionKindsAttributesSystemInfo.containsKey(conceptionKindName)){
                        ...
                        for(AttributeSystemInfo currentAttributeSystemInfo :currentConceptionKindAttributesSysInfo){
                            ...
                            infoIcon.addClickListener(clickEvent -> {
                                renderSampleRandomAttributesView(conceptionKindName,attributeName,attributeInfo);
                            });
    ...
    private void renderSampleRandomAttributesView(String conceptionKind,String attributeName,Span attributeInfo){
        AttributesValueListView attributesValueListView = new AttributesValueListView(AttributesValueListView.AttributeKindType.ConceptionKind,conceptionKind,attributeName);
        popover.removeAll();
