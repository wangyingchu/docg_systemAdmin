...
public class RelationEntityAttributesEditorView extends VerticalLayout {
    ...
    private void renderShowMetaInfoUI(){
        ConceptionEntityMetaInfoView conceptionEntityMetaInfoView = new ConceptionEntityMetaInfoView(this.relationKind,this.relationEntityUID);
        FixSizeWindow fixSizeWindow = new FixSizeWindow(new Icon(VaadinIcon.INFO_CIRCLE_O),"概念实体元数据信息",null,true,500,440,false);
