...
public class ConceptionEntityRelationInfoView extends VerticalLayout implements
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        getUI().ifPresent(ui -> listener = ui.getPage().addBrowserWindowResizeListener(event -> {
            relationEntitiesGrid.setHeight(event.getHeight()-this.conceptionEntityRelationInfoViewHeightOffset+20, Unit.PIXELS);
        }));
        // Adjust size according to initial width of the screen
        getUI().ifPresent(ui -> ui.getPage().retrieveExtendedClientDetails(receiver -> {
            int browserHeight = receiver.getBodyClientHeight();
            relationEntitiesGrid.setHeight(browserHeight-this.conceptionEntityRelationInfoViewHeightOffset+20,Unit.PIXELS);
        }));
    }
