...
public class RelationEntityAttributeUpdatedEvent implements Event {
    ...
    public interface RelationEntityAttributeUpdatedListener extends Listener {
        public void receivedRelationEntityAttributeUpdatedEvent(final RelationEntityAttributeUpdatedEvent event);
    }
}
